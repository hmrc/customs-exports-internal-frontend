...
class FieldValidatorSpec extends UnitSpec {
  ...
  "FormFieldValidator validMucr" should {
    ...
    "return true" when {
      "using test constant" in {
        validMucr(ValidMucr) mustBe true
      }
  ...
  "FormFieldValidator validDucr" should {
    ...
    "return true" when {
      "using test constant" in {
        validDucr(ValidDucr) mustBe true
      }
  ...
  "FormFieldValidator lengthInRagnge" should {
    ...
    "return true" when {
      ...
      "input string has minimum length" in {
        ...
        lengthInRange(5)(10)(Random.nextString(5)) mustBe true
      }

      "input string is between minimum and maximum length" in {

        lengthInRange(5)(10)(Random.nextString(7)) mustBe true
      }

      "input string has maximum length" in {

        lengthInRange(5)(10)(Random.nextString(10)) mustBe true
      }
    }
    ...
    "return false" when {
      ...
      "input string is shorter than allowed" in {
        ...
        lengthInRange(5)(10)(Random.nextString(2)) mustBe false
      }

      "input string is longer than allowed" in {

        lengthInRange(5)(10)(Random.nextString(11)) mustBe false
      }
    }
  }
